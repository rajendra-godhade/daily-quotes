...
const SignInEmail: React.FC = () => {
  ...
  const handleVerifyOtp = async (e: React.FormEvent) => {
    ...
    try {
      // Try different OTP verification methods
      let verificationResult = null;
      let verificationError = null;

      // Method 1: Try email OTP verification
      try {
      ...
      // Method 2: If email OTP fails, try magic link verification
      ...
      // Method 3: If both fail, try recovery
      if (verificationError) {
        try {
          const { data, error } = await supabase.auth.verifyOtp({
            email,
      ...
      // If there's an error, clear any stale session
  ...
  return (
    <div className="signin-root">
        ...
        <div className="signin-form-box">
          ...
          {step === 'email' && (
            <form onSubmit={handleSendOtp} className="signin-form">
              <div className="form-group">
                ...
                />
                <p className="signin-help">We'll send a secure code to your email</p>
              </div>
          ...
          {step === 'otp' && (
            <form onSubmit={handleVerifyOtp} className="signin-form">
              <div className="form-group">
                <label htmlFor="otp" className="signin-label">Verification Code</label>
                <input
                  id="otp"
                  type="text"
                ...
                />
                <p className="signin-help">Enter the 6-digit code sent to {email}</p>
              </div>
      ...
      <style>{`
        ...
        .signin-magic-btn:hover:not(:disabled) {
          background: #3b82f6;
          color: #fff;
